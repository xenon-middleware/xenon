...
public class FtpFileSystemSimpleTests {

    @Test(expected = InvalidCredentialException.class)
    public void test_invalid_credential_type() throws XenonException {
        new FtpFileAdaptor().createFileSystem("localhost", new CredentialMap(), null);
    }

    @Test(expected = InvalidCredentialException.class)
    public void test_credential_null() throws XenonException {
        new FtpFileAdaptor().createFileSystem("localhost", null, null);
    }

    @Test(expected = InvalidLocationException.class)
    public void test_location_null() throws XenonException {
        new FtpFileAdaptor().createFileSystem(null, new PasswordCredential("aap", "noot".toCharArray()), null);
    }

    @Test(expected = InvalidLocationException.class)
    public void test_location_empty() throws XenonException {
        new FtpFileAdaptor().createFileSystem("", new PasswordCredential("aap", "noot".toCharArray()), null);
    }
}
