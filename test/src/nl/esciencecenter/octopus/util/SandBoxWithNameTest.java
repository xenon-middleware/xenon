 ...
 *
 */
public class SandBoxWithNameTest {
    ...
    public void test() throws OctopusException, OctopusIOException {
        ...
        Sandbox sandbox = new Sandbox(octopus, files.newPath(fs, new RelativePath("/tmp")), "AAP");
        
        assertEquals(sandbox.getPath().getPath(), "/tmp/AAP");
