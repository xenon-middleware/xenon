...
public class GridEngineSchedulerConnectionTest {
    ...
    @Test
    public void test03a_getJobStatusFromQacctInfo_doneJob_JobStatus() throws OctopusException {
    ...
    @Test
    public void test03b_getJobStatusFromQacctInfo_CanceledJob_JobStatusWithException() throws OctopusException {
        String jobnumber = "555";
        Map<String, String> jobInfo = new HashMap<String, String>();
        jobInfo.put("jobnumber", jobnumber);
    ...
    @Test
    public void test03c_getJobStatusFromQacctInfo_JobWithNonZeroexit_status_JobStatusWithNoException() throws OctopusException {
        String jobnumber = "555";
        Map<String, String> jobInfo = new HashMap<String, String>();
        jobInfo.put("jobnumber", jobnumber);
    ...
    @Test
    public void test03d_getJobStatusFromQacctInfo_FailedJob_JobStatusWithException() throws OctopusException {
        String jobnumber = "555";
        Map<String, String> jobInfo = new HashMap<String, String>();
        jobInfo.put("jobnumber", jobnumber);
    ...
    @Test
    public void test03e_getJobStatusFromQacctInfo_NullInput_NullReturned() throws OctopusException {
        String jobnumber = "555";
        Job job = new FakeScriptingJob(jobnumber);
    ...
    public void test03f_getJobStatusFromQacctInfo_IncompleteJobInfo_ExceptionThrown() throws OctopusException {
        String jobnumber = "555";
        //empty job info
        Map<String, String> jobInfo = new HashMap<String, String>();
    ...
    @Test(expected = OctopusException.class)
    public void test03g_getJobStatusFromQacctInfo_ExitCodeNotANumber_ExceptionThrown() throws OctopusException {
        String jobnumber = "555";
        //empty job info
        Map<String, String> jobInfo = new HashMap<String, String>();
        jobInfo.put("jobnumber", jobnumber);
    ...
    @Test
    public void test04a_getJobStatusFromQstatInfo_PendingJob_JobStatus() throws OctopusException {
        String jobID = "555";
        Map<String, String> jobInfo = new HashMap<String, String>();
    ...
    @Test
    public void test04b_getJobStatusFromQstatInfo_RunningJob_JobStatus() throws OctopusException {
        String jobID = "555";
        Map<String, String> jobInfo = new HashMap<String, String>();
        jobInfo.put("JB_job_number", jobID);
        jobInfo.put("state", "r");
    ...
    @Test
    public void test04c_getJobStatusFromQstatInfo_ErrorJob_JobStatusWithExcepion() throws OctopusException {
        String jobID = "555";
        Map<String, String> jobInfo = new HashMap<String, String>();
        jobInfo.put("JB_job_number", jobID);
    ...
    @Test
    public void test04d_getJobStatusFromQstatInfo_JobNotInMap_NullReturned() throws OctopusException {
        String jobID = "555";
        Map<String, Map<String, String>> input = new HashMap<String, Map<String, String>>();
        Job job = new FakeScriptingJob(jobID);
        JobStatus result = GridEngineSchedulerConnection.getJobStatusFromQstatInfo(input, job);
    ...
    @Test(expected = OctopusException.class)
    public void test04e_getJobStatusFromQstatInfo_IncompleteJobInfo_ExceptionThrown() throws OctopusException {
        String jobID = "555";
