...
public class Deadline {
     ...
     *
     * This deadline is computed by adding the <code>timeout</code> to <code>System.currentTimeMillis()</code>. This computation is protected against overflow,
     * that is, the deadline will never exceed <code>Long.MAX_VALUE</code>.
     *
     ...
     * @return the timestamp at which the timeout will expire, or <code>Long.MAX_VALUE</code> if the timeout causes an overflow.
     */
