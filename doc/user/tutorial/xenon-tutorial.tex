...
% so now I want to play with it some more. I need an editor, including static code checking with PMD, a unit testing environment and an integration environment.
