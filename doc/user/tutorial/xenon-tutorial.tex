...
\title{\textbf{Distributed Computing with Xenon} \\ user manual}
...
It is assumed that you are using one of the Ubuntu-based operating systems (I'm using Linux Lubuntu 14.10). Nonetheless, most of the material covered in this manual should be usable on other Linux distributions with minor changes. The manual is written to be consistent with Xenon\url{@4230b73}\footnote{commit \url{https://github.com/NLeSC/Xenon/tree/4230b73}}.
...
\item{\textit{Texlive}\index{Texlive}, a \TeX{} typesetting system;}
\item{\textit{Pandoc}\index{Pandoc}, a markup language conversion tool.}
% TODO what about a local install of Jenkins
% TODO what about a local install of SonarQube
\end{enumerate}
