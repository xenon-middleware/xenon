...
import nl.esciencecenter.xenon.adaptors.file.ftp.FtpInputStream;
...
public class FtpInputStreamTest {
    ...
    public void close_callTwice_completePendingCommandOnlyOnce() throws IOException {
        ...
        FtpInputStream ftpInputStream = new FtpInputStream(stream, ftpClient, mock(Path.class), mock(FtpFileAdaptor.class));
