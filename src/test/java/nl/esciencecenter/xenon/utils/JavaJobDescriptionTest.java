...
public class JavaJobDescriptionTest {
    ...
    public void toString_default() {
        ...
        String expected = "JavaJobDescription [javaOptions=[], javaSystemProperties={}, javaMain=null, javaArguments=[], javaClassPath=[], queueName=null, executable=java, stdin=null, stdout=null, stderr=null, workingDirectory=null, environment={}, jobOptions={}, nodeCount=1, processesPerNode=1, maxTime=15]";
