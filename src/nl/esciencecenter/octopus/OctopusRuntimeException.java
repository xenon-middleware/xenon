...
/**
 * OctopusRuntimeException is the parent for all runtime exceptions raised in Octopus. 
 * 
 * Next to the regular exception message and cause, OctopusRuntimeException add a source adaptor name to all runtime exceptions.  
 * 
