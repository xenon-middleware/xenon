...
public class JobScriptGenerator {
    ...
    private static void generateParallelEnvironmentSpecification(JobDescription description, GridEngineSetup setupInfo, Formatter script) throws OctopusException {
    ...
    public static String generate(JobDescription description, AbsolutePath fsEntryPath, GridEngineSetup setup) throws OctopusException {
