...
public class SshUtil {
    ...
    static final int READ_OWNER = 00400; // read by owner
    static final int WRITE_OWNER = 00200; // write by owner
    static final int EXEC_OWNER = 00100; // execute/search by owner
