...
/**
 * OctopusException is the parent exception for all exceptions raised in Octopus. 
 * 
 * Next to the regular exception message and cause, OctopusException add a source adaptor name to all exceptions.  
 * 
