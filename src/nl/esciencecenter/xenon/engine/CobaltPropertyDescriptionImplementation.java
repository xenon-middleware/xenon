 ...
 * @since 1.0
 */
public class CobaltPropertyDescriptionImplementation implements CobaltPropertyDescription {

    private final String name;
    private final CobaltPropertyDescription.Type type;
    private final Set<CobaltPropertyDescription.Component> levels;
    private final String defaultValue;
    private final String description;

    public CobaltPropertyDescriptionImplementation(String name, Type type, Set<Component> levels, String defaultValue,
            String description) {
