...
public class CobaltProperties {
     ...
     */
    private CobaltProperties(Map<String, CobaltPropertyDescription> supportedProperties, Map<String, String> properties) {
     ...
     */
    public CobaltProperties(ImmutableArray<CobaltPropertyDescription> supportedProperties, Map<String, String> properties)
        ...
        for (CobaltPropertyDescription d : supportedProperties) {
     ...
     *             <code>supportedProperties</code>.
     */
    public CobaltProperties(ImmutableArray<CobaltPropertyDescription> supportedProperties, Component level, 
    ...
    private void addProperties(Map<String, String> properties) throws UnknownPropertyException, InvalidPropertyException {
        ...
        for (Entry<String, String> e : properties.entrySet()) {
            ...
            CobaltPropertyDescription d = supportedProperties.get(key);
    ...
    private void checkType(CobaltPropertyDescription description, String key, String value) throws InvalidPropertyException {
    ...
    public String getProperty(String name) throws UnknownPropertyException {
        ...
        CobaltPropertyDescription d = supportedProperties.get(name);
     ...
     *            the desired prefix
     */
    public CobaltProperties filter(String prefix) {
        ...
        HashMap<String, CobaltPropertyDescription> remaining = new HashMap<>();
        ...
        return new CobaltProperties(remaining, p);
    }
     ...
     *            the desired prefix
     */
    public CobaltProperties filter(Component level) {

        HashMap<String, CobaltPropertyDescription> remaining = new HashMap<>();
        HashMap<String, String> p = new HashMap<>();

        for (CobaltPropertyDescription d : supportedProperties.values()) {
    ...
    public CobaltPropertyDescription[] getSupportedProperties() {
        Collection<CobaltPropertyDescription> tmp = supportedProperties.values();
        return tmp.toArray(new CobaltPropertyDescription[tmp.size()]);
    }
