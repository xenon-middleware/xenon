...
public class Slurm14SchedulerDockerTest extends SlurmSchedulerTestParent {

    @ClassRule
    public static DockerComposeRule docker = DockerComposeRule.builder().file("src/integrationTest/resources/docker-compose/slurm-14.yml")
