...
public class Slurm16SchedulerDockerTest extends SlurmSchedulerTestParent {

    @ClassRule
    public static DockerComposeRule docker = DockerComposeRule.builder().file("src/integrationTest/resources/docker-compose/slurm-16.yml")
