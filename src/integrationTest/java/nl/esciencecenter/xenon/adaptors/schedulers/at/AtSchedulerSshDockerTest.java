...
public class AtSchedulerSshDockerTest extends AtSchedulerTestParent {
    ...
    protected SchedulerLocationConfig setupLocationConfig() {
        return new AtLocationConfig(docker.containers().container("ssh").port(22).inFormat("ssh://$HOST:$EXTERNAL_PORT"), "/home/xenon");
    }
    ...
    public Scheduler setupScheduler(SchedulerLocationConfig config) throws XenonException {
        ...
        return Scheduler.create("at", config.getLocation(), cred, props);
    }
}
