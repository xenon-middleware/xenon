 ...
 *
 */
public class LocalAdaptorFactory extends AdaptorFactory {

    @Override
    public String getPropertyPrefix() {
        return LocalAdaptor.PREFIX;
    }

    @Override
    public XenonPropertyDescription [] getSupportedProperties() {
        return LocalAdaptor.VALID_PROPERTIES.asArray();
    }

    @Override
    public Adaptor createAdaptor(XenonEngine engine, Map<String, String> properties) throws XenonException {
        return new LocalAdaptor(engine, properties);
    }
}
