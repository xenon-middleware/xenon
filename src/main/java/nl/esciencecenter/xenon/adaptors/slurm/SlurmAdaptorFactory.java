 ...
 *
 */
public class SlurmAdaptorFactory extends AdaptorFactory {

    @Override
    public String getPropertyPrefix() {
        return SlurmAdaptor.PREFIX;
    }

    @Override
    public XenonPropertyDescription [] getSupportedProperties() {
        return SlurmAdaptor.VALID_PROPERTIES.asArray();
    }

    @Override
    public Adaptor createAdaptor(XenonEngine engine, Map<String, String> properties) throws XenonException {
        return new SlurmAdaptor(engine, properties);
    }
}
