...
public class SlurmSchedulerAdaptor extends ScriptingSchedulerAdaptor {
    ...
    public static final XenonPropertyDescription[] VALID_PROPERTIES = new XenonPropertyDescription[] { new XenonPropertyDescription(DISABLE_ACCOUNTING_USAGE,
            Type.BOOLEAN, "false", "Do not use accounting info of slurm, even when available. Mostly for testing purposes"),
