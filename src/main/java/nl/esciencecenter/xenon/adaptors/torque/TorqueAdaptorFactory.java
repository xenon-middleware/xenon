 ...
 *
 */
public class TorqueAdaptorFactory extends AdaptorFactory {

    @Override
    public String getPropertyPrefix() {
        return TorqueAdaptor.PREFIX;
    }

    @Override
    public XenonPropertyDescription [] getSupportedProperties() {
        return TorqueAdaptor.VALID_PROPERTIES.asArray();
    }

    @Override
    public Adaptor createAdaptor(XenonEngine engine, Map<String, String> properties) throws XenonException {
        return new TorqueAdaptor(engine, properties);
    }
}
