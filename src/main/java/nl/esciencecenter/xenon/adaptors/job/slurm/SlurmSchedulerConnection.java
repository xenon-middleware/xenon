...
import static nl.esciencecenter.xenon.adaptors.job.slurm.SlurmProperties.ADAPTOR_NAME;
import static nl.esciencecenter.xenon.adaptors.job.slurm.SlurmProperties.DISABLE_ACCOUNTING_USAGE;
import static nl.esciencecenter.xenon.adaptors.job.slurm.SlurmProperties.IGNORE_VERSION_PROPERTY;
import static nl.esciencecenter.xenon.adaptors.job.slurm.SlurmProperties.POLL_DELAY_PROPERTY;
...
public class SlurmSchedulerConnection extends SchedulerConnection {
    ...
    protected static JobStatus getJobStatusFromSacctInfo(Map<String, Map<String, String>> info, Job job) throws XenonException {
        ...
        SchedulerConnection.verifyJobInfo(jobInfo, job, ADAPTOR_NAME, "JobID", "State", "ExitCode");
    ...
    protected static JobStatus getJobStatusFromScontrolInfo(Map<String, String> jobInfo, Job job) throws XenonException {
        ...
        //also checks if the job id is correct
        SchedulerConnection.verifyJobInfo(jobInfo, job, ADAPTOR_NAME, "JobId", "JobState", "ExitCode", "Reason");
    ...
    protected static JobStatus getJobStatusFromSqueueInfo(Map<String, Map<String, String>> info, Job job) throws XenonException {
        ...
        //also checks if the job id is correct
        SchedulerConnection.verifyJobInfo(jobInfo, job, ADAPTOR_NAME, "JOBID", "STATE");
    ...
    protected  static void verifyJobDescription(JobDescription description) throws XenonException {
        SchedulerConnection.verifyJobOptions(description.getJobOptions(), VALID_JOB_OPTIONS, ADAPTOR_NAME);
        ...
        SchedulerConnection.verifyJobDescription(description, ADAPTOR_NAME);
    }
    ...
    protected SlurmSchedulerConnection(String location, Credential credential, XenonProperties properties) throws XenonException {
        ...
        boolean disableAccounting = getProperties().getBooleanProperty(DISABLE_ACCOUNTING_USAGE);
        ...
        scheduler = new SchedulerImplementation(ADAPTOR_NAME, getID(), location, foundQueueNames,
