...
//        }
        ...
        LOGGER.debug("creating sub scheduler for {} adaptor at {}://{}", adaptorName, subJobScheme, subLocation);
    ...
    public String runCheckedCommand(String stdin, String executable, String... arguments) throws XenonException {
        ...
        if (!runner.success()) {
            throw new XenonException(adaptorName, "could not run command \"" + executable + "\" with stdin \"" + stdin
