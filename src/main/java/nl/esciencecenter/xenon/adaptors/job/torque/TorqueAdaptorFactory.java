...
import static nl.esciencecenter.xenon.adaptors.job.torque.TorqueProperties.ADAPTOR_DESCRIPTION;
import static nl.esciencecenter.xenon.adaptors.job.torque.TorqueProperties.ADAPTOR_LOCATIONS;
import static nl.esciencecenter.xenon.adaptors.job.torque.TorqueProperties.ADAPTOR_NAME;
import static nl.esciencecenter.xenon.adaptors.job.torque.TorqueProperties.ADAPTOR_SCHEMES;
import static nl.esciencecenter.xenon.adaptors.job.torque.TorqueProperties.PREFIX;
import static nl.esciencecenter.xenon.adaptors.job.torque.TorqueProperties.VALID_PROPERTIES;
 ...
 *
 */
public class TorqueAdaptorFactory implements JobAdaptorFactory {
