 ...
 *
 */
public class WebdavAdaptorFactory extends AdaptorFactory {

    @Override
    public String getPropertyPrefix() {
        return WebdavAdaptor.PREFIX;
    }

    @Override
    public XenonPropertyDescription [] getSupportedProperties() {
        return WebdavAdaptor.VALID_PROPERTIES.asArray();
    }

    @Override
    public Adaptor createAdaptor(XenonEngine engine, Map<String, String> properties) throws XenonException {
        return new WebdavAdaptor(engine, properties);
    }
}
