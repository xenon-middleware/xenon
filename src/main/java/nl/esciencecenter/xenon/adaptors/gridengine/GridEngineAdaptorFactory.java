 ...
 *
 */
public class GridEngineAdaptorFactory extends AdaptorFactory {

    @Override
    public String getPropertyPrefix() {
        return GridEngineAdaptor.PREFIX;
    }

    @Override
    public XenonPropertyDescription [] getSupportedProperties() {
        return GridEngineAdaptor.VALID_PROPERTIES.asArray();
    }

    @Override
    public Adaptor createAdaptor(XenonEngine engine, Map<String, String> properties) throws XenonException {
        return new GridEngineAdaptor(engine, properties);
    }
}
