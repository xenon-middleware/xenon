...
public class JavaJobDescription extends JobDescription {
    ...
    public String toString() {
        return "JavaJobDescription [javaOptions=" + javaOptions + ", javaSystemProperties=" + javaSystemProperties + ", javaMain=" + javaMain
                ...
                + ", environment=" + getEnvironment() + ", jobOptions=" + getJobOptions() + ", nodeCount=" + getNodeCount() + ", processesPerNode="
                + getProcessesPerNode() + ", maxTime=" + getMaxRuntime() + "]";
    }
    ...
    public boolean equals(Object obj) {
        ...
        return super.equals(obj) && javaArguments.equals(other.javaArguments) && javaClasspath.equals(other.javaClasspath)
                && Objects.equals(javaMain, other.javaMain) && javaOptions.equals(other.javaOptions) && javaSystemProperties.equals(other.javaSystemProperties);
    }
